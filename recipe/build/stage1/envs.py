...
if TYPE_CHECKING:
    ...
    VLLM_NVFP4_KV_VOSPLIT: bool = True  # NVFP4KV-PORT
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # NVFP4 KV cache VO-split on consumer Blackwell (CC 12.x): route  # NVFP4KV-PORT
    # Gemma-4 heterogeneous-head full-attention layers (head_dim_qk=512,  # NVFP4KV-PORT
    # head_dim_vo=256) through the FlashInfer FA2 asymmetric paged kernel.  # NVFP4KV-PORT
    # Default-on for nvfp4 KV; "0" is the escape hatch. Not consumed by the  # NVFP4KV-PORT
    # lean dense-GQA (head_dim=256, vo_split==1) path ported here.  # NVFP4KV-PORT
    "VLLM_NVFP4_KV_VOSPLIT": lambda: bool(  # NVFP4KV-PORT
        int(os.getenv("VLLM_NVFP4_KV_VOSPLIT", "1"))  # NVFP4KV-PORT
    ),  # NVFP4KV-PORT
