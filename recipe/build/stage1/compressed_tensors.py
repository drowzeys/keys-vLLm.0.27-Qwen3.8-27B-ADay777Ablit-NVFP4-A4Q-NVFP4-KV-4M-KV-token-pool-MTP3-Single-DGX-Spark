...
class CompressedTensorsKVCacheMethod(BaseKVCacheMethod):
    ...
    def validate_kv_cache_scheme(kv_cache_scheme: dict[str, Any] | None):
        ...
        # num_bits=8 -> fp8 KV; num_bits=4 -> nvfp4 KV (consumer Blackwell FA2).  # NVFP4KV-PORT
        if type_ != "float" or num_bits not in (4, 8):  # NVFP4KV-PORT
            raise NotImplementedError(
                "Currently supported kv cache quantization is "
                "num_bits in (4, 8), type=float, however "  # NVFP4KV-PORT
